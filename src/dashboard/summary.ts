...
export function getCategorySummaries(history: Movimiento[], companyName?: string) {
  ...
  // Performance optimization: use a single for...of loop instead of chaining .filter().forEach()
  // to avoid intermediate array allocations and reduce iteration overhead on large datasets.
