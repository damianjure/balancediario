        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              disabled={creating}
              className="inline-flex items-center gap-2 rounded-2xl bg-neutral-900 px-4 py-3 text-white font-medium hover:bg-neutral-800 disabled:opacity-50"
            >
              {creating ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
            ...
            {status?.telegramDeepLink && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-2xl border border-neutral-200 px-4 py-3 text-neutral-700 font-medium hover:bg-neutral-50"
              >
                Abrir Telegram
              </a>
            )}
